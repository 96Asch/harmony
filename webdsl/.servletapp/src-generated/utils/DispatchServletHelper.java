...
String[] s={};
Boolean[] b={};
pages.put("RemoveSongs",new utils.PageDispatch(RemoveSongsPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("RemoveSetlists",new utils.PageDispatch(RemoveSetlistsPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
String[] s={};
Boolean[] b={};
pages.put("loginService",new utils.PageDispatch(LoginServicePage.class,s,b,false));
}
{
String[] s={"setlist","index"};
Boolean[] b={false,false};
pages.put("Live",new utils.PageDispatch(LivePage.class,s,b,false));
}
{
String[] s={"song"};
Boolean[] b={false};
pages.put("getMP3",new utils.PageDispatch(GetMP3Page.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("getAvatarURLs",new utils.PageDispatch(GetAvatarURLsPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
pages.put("Dashboard",new utils.PageDispatch(DashboardPage.class,s,b,false));
}
{
String[] s={};
Boolean[] b={};
...
{
String[] s={"owner","query","ph"};
Boolean[] b={false,false,false};
pages.put("userSearchUser_String_Placeholder",new utils.PageDispatch(UserSearchUser_String_PlaceholderPage.class,s,b,true));
}
{
String[] s={"query","ph","searchPublic","multipleAllowed"};
Boolean[] b={false,false,false,false};
pages.put("songSearchString_Placeholder_Bool_Bool",new utils.PageDispatch(SongSearchString_Placeholder_Bool_BoolPage.class,s,b,true));
}
{
String[] s={"query","ph"};
Boolean[] b={false,false};
pages.put("slSearchString_Placeholder",new utils.PageDispatch(SlSearchString_PlaceholderPage.class,s,b,true));
}
{
String[] s={"list"};
Boolean[] b={false};
...
String[] s={"ph"};
Boolean[] b={false};
pages.put("RegisterPlaceholder",new utils.PageDispatch(RegisterPlaceholderPage.class,s,b,true));
}
{
String[] s={};
Boolean[] b={};
...
String[] s={"ph"};
Boolean[] b={false};
pages.put("LoginPlaceholder",new utils.PageDispatch(LoginPlaceholderPage.class,s,b,true));
}
{
String[] s={"song"};
Boolean[] b={false};
pages.put("EditSongModalSong",new utils.PageDispatch(EditSongModalSongPage.class,s,b,true));
}
{
String[] s={"setlist"};
Boolean[] b={false};
pages.put("EditSetListModalSetList",new utils.PageDispatch(EditSetListModalSetListPage.class,s,b,true));
}
{
String[] s={};
Boolean[] b={};
pages.put("AddSongModal",new utils.PageDispatch(AddSongModalPage.class,s,b,true));
}
{
String[] s={};
Boolean[] b={};
pages.put("AddSetListModal",new utils.PageDispatch(AddSetListModalPage.class,s,b,true));
}
}
