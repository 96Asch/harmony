...
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"ValidationExceptionMultiple").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"ValidationException").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"RequestLogEntry").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"QueuedEmail").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"SetListInvitation").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"Notification").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"SetList").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"Song").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"User").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"TempFormData").executeUpdate();
...
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"SongKey").executeUpdate();
utils.HibernateUtil.getCurrentSession().createQuery("delete from "+"NotificationType").executeUpdate();
