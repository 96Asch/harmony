...
@SuppressWarnings("all")public class getNonPendingMembers_listCompr0SetList_{
public static java.util.List<webdsl.generated.domain.User> getNonPendingMembers_listCompr0SetList_(webdsl.generated.domain.SetList setlist_){
...
java.util.Set<webdsl.generated.domain.User> thecollection_=((webdsl.generated.domain.TempFormData)utils.ThreadLocalPage.getEnv().getSessionVariable("tempFormData")).getUsers();
