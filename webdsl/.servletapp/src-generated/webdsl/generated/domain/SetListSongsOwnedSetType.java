...
@SuppressWarnings("unchecked")public class SetListSongsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new SetListSongsSet(anticipatedSize<1?0:anticipatedSize);
}
