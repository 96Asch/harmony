...
@SuppressWarnings("unchecked")public class BandSetListsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandSetListsSet(anticipatedSize<1?0:anticipatedSize);
}
