...
import javax.persistence.*;import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_NotificationType")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class NotificationType implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static NotificationType _static_createEmpty_(){
NotificationType ent=new NotificationType();
ent.setId(java.util.UUID.randomUUID());
return ent;
}
public static NotificationType _static_cast_(Object o){
return (NotificationType)org.webdsl.tools.Utils.cast(o,NotificationType.class);
}
...
thepage.invalidateAllPageCache("NotificationType"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"NotificationType"+"."+prop);
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("NotificationType")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?NotificationType.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):NotificationType.class.cast(o)).getId(),getId());
}
public NotificationType save(String webdslTypeName){
setVersion(1);
...
return getId().compareTo(((NotificationType)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("NotificationType")||s.equals("Object")||s.equals("Entity");
}
...
public NotificationType setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public NotificationType setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public NotificationType setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged("name");
...
return utils.HibernateUtil.getCurrentSession().createQuery("from NotificationType").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from NotificationType").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.NotificationType> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from NotificationType as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.NotificationType> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from NotificationType as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.NotificationType _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.NotificationType._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"NotificationType",prop_));
}
public webdsl.generated.domain.NotificationType NotificationType$this_(){
this.NotificationType_();
return this;
}
public void NotificationType_(){}
