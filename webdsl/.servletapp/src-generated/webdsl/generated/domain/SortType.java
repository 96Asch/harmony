...
import javax.persistence.*;import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_SortType")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class SortType implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static SortType _static_createEmpty_(){
SortType ent=new SortType();
ent.setId(java.util.UUID.randomUUID());
return ent;
}
public static SortType _static_cast_(Object o){
return (SortType)org.webdsl.tools.Utils.cast(o,SortType.class);
}
public  SortType(){}
...
thepage.invalidateAllPageCache("SortType"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"SortType"+"."+prop);
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("SortType")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?SortType.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):SortType.class.cast(o)).getId(),getId());
}
public SortType save(String webdslTypeName){
setVersion(1);
...
return getId().compareTo(((SortType)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("SortType")||s.equals("Object")||s.equals("Entity");
}
...
public SortType setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public SortType setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public SortType setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged("name");
...
return utils.HibernateUtil.getCurrentSession().createQuery("from SortType").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from SortType").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.SortType> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SortType as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.SortType> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SortType as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.SortType _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.SortType._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"SortType",prop_));
}
public webdsl.generated.domain.SortType SortType$this_(){
this.SortType_();
return this;
}
