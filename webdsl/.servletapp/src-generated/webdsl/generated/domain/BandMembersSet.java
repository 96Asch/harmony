...
@SuppressWarnings("unchecked")public class BandMembersSet extends utils.OwnedSet<webdsl.generated.domain.User>{
public  BandMembersSet(){
super();
}
public  BandMembersSet(int anticipatedSize){
super(anticipatedSize);
}
public  BandMembersSet(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  BandMembersSet(Object owner){
super(owner);
}
public  BandMembersSet(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  BandMembersSet(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
