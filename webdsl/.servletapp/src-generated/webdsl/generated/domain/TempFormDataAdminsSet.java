...
@SuppressWarnings("unchecked")public class TempFormDataAdminsSet extends utils.OwnedSet<webdsl.generated.domain.User>{
public  TempFormDataAdminsSet(){
super();
}
public  TempFormDataAdminsSet(int anticipatedSize){
super(anticipatedSize);
}
public  TempFormDataAdminsSet(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  TempFormDataAdminsSet(Object owner){
super(owner);
}
public  TempFormDataAdminsSet(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  TempFormDataAdminsSet(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
