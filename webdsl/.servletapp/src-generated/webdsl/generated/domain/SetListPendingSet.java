...
@SuppressWarnings("unchecked")public class SetListPendingSet extends utils.OwnedSet<webdsl.generated.domain.User>{
public  SetListPendingSet(){
super();
}
public  SetListPendingSet(int anticipatedSize){
super(anticipatedSize);
}
public  SetListPendingSet(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  SetListPendingSet(Object owner){
super(owner);
}
public  SetListPendingSet(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  SetListPendingSet(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
