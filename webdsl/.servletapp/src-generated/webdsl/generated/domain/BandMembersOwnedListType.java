...
@SuppressWarnings("unchecked")public class BandMembersOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandMembersList(anticipatedSize<1?0:anticipatedSize);
}
