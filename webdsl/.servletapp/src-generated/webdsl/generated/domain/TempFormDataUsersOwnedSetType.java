...
@SuppressWarnings("unchecked")public class TempFormDataUsersOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataUsersSet(anticipatedSize<1?0:anticipatedSize);
}
