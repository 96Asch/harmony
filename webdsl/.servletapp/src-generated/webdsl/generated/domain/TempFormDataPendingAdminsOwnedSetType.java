...
@SuppressWarnings("unchecked")public class TempFormDataPendingAdminsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataPendingAdminsSet(anticipatedSize<1?0:anticipatedSize);
}
