...
@SuppressWarnings("unchecked")public class SetListSongsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new SetListSongsList(anticipatedSize<1?0:anticipatedSize);
}
