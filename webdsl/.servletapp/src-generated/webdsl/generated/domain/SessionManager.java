...
@ManyToOne(fetch=javax.persistence.FetchType.LAZY)@JoinColumn(name="\"SessionManager_tempFormData\"")@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.ALL,org.hibernate.annotations.CascadeType.DELETE_ORPHAN})@org.hibernate.annotations.AccessType(value="field")protected webdsl.generated.domain.TempFormData _tempFormData=null;
public webdsl.generated.domain.TempFormData getTempFormData(){
return _tempFormData;
}
public boolean isTempFormDataUninitialized(){
return _tempFormData instanceof org.hibernate.proxy.HibernateProxy&&((org.hibernate.proxy.HibernateProxy)_tempFormData).getHibernateLazyInitializer().isUninitialized();
}
public SessionManager setTempFormData(webdsl.generated.domain.TempFormData newitem){
if(!tempFormDataBeingSet){
tempFormDataBeingSet=true;
setChanged("tempFormData");
this.setTempFormDataTempFormData_(newitem);
webdsl.generated.domain.TempFormData olditem=_tempFormData;
_tempFormData=newitem;
tempFormDataBeingSet=false;
}
return this;
}
public void setTempFormDataNoEventsOrValidation(webdsl.generated.domain.TempFormData newitem){
setChanged("tempFormData");
webdsl.generated.domain.TempFormData olditem=_tempFormData;
_tempFormData=newitem;
}
@Transient boolean tempFormDataBeingSet=false;
...
public java.util.List<webdsl.generated.domain.TempFormData> allowedTempFormData_(){
return (java.util.List<webdsl.generated.domain.TempFormData>)(java.util.List<?>)webdsl.generated.domain.TempFormData.$static$all_();
}
...
public void validateTempFormData_internalValidationExceptionMultiple_(webdsl.generated.domain.ValidationExceptionMultiple v_){}
public webdsl.generated.domain.ValidationExceptionMultiple validateTempFormData_(){
webdsl.generated.domain.ValidationExceptionMultiple v_=webdsl.generated.domain.ValidationExceptionMultiple._static_createEmpty_();
this.validateTempFormData_internalValidationExceptionMultiple_(v_);
return v_;
}
...
public void setTempFormDataTempFormData_(webdsl.generated.domain.TempFormData value_){}
