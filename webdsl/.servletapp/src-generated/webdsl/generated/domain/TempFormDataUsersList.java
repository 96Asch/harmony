...
@SuppressWarnings("unchecked")public class TempFormDataUsersList extends utils.OwnedList<webdsl.generated.domain.User>{
public  TempFormDataUsersList(){
super();
}
public  TempFormDataUsersList(int anticipatedSize){
super(anticipatedSize);
}
public  TempFormDataUsersList(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  TempFormDataUsersList(Object owner){
super(owner);
}
public  TempFormDataUsersList(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  TempFormDataUsersList(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
