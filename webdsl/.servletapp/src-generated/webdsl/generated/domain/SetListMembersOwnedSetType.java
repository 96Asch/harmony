...
@SuppressWarnings("unchecked")public class SetListMembersOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new SetListMembersSet(anticipatedSize<1?0:anticipatedSize);
}
