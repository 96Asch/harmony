...
@SuppressWarnings("unchecked")public class BandAdminsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandAdminsList(anticipatedSize<1?0:anticipatedSize);
}
