...
@SuppressWarnings("unchecked")public class TempFormDataAdminsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataAdminsList(anticipatedSize<1?0:anticipatedSize);
}
