...
@SuppressWarnings("unchecked")public class BandMembersList extends utils.OwnedList<webdsl.generated.domain.User>{
public  BandMembersList(){
super();
}
public  BandMembersList(int anticipatedSize){
super(anticipatedSize);
}
public  BandMembersList(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  BandMembersList(Object owner){
super(owner);
}
public  BandMembersList(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  BandMembersList(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
