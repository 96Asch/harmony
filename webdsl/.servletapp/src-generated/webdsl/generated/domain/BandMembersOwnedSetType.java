...
@SuppressWarnings("unchecked")public class BandMembersOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandMembersSet(anticipatedSize<1?0:anticipatedSize);
}
