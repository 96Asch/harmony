...
@SuppressWarnings("unchecked")public class SetListAdminsList extends utils.OwnedList<webdsl.generated.domain.User>{
public  SetListAdminsList(){
super();
}
public  SetListAdminsList(int anticipatedSize){
super(anticipatedSize);
}
public  SetListAdminsList(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  SetListAdminsList(Object owner){
super(owner);
}
public  SetListAdminsList(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  SetListAdminsList(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
