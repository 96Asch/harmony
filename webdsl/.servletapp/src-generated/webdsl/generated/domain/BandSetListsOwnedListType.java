...
@SuppressWarnings("unchecked")public class BandSetListsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandSetListsList(anticipatedSize<1?0:anticipatedSize);
}
