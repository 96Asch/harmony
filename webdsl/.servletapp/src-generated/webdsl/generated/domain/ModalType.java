...
import javax.persistence.*;import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_ModalType")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class ModalType implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static ModalType _static_createEmpty_(){
ModalType ent=new ModalType();
ent.setId(java.util.UUID.randomUUID());
return ent;
}
public static ModalType _static_cast_(Object o){
return (ModalType)org.webdsl.tools.Utils.cast(o,ModalType.class);
}
public  ModalType(){}
...
thepage.invalidateAllPageCache("ModalType"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"ModalType"+"."+prop);
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("ModalType")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?ModalType.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):ModalType.class.cast(o)).getId(),getId());
}
public ModalType save(String webdslTypeName){
setVersion(1);
...
return getId().compareTo(((ModalType)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("ModalType")||s.equals("Object")||s.equals("Entity");
}
...
public ModalType setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public ModalType setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public ModalType setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged("name");
...
return utils.HibernateUtil.getCurrentSession().createQuery("from ModalType").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from ModalType").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.ModalType> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from ModalType as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.ModalType> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from ModalType as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.ModalType _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.ModalType._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"ModalType",prop_));
}
public webdsl.generated.domain.ModalType ModalType$this_(){
this.ModalType_();
return this;
}
public void ModalType_(){}
