...
@SuppressWarnings("unchecked")public class TempFormDataPendingMembersOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataPendingMembersSet(anticipatedSize<1?0:anticipatedSize);
}
