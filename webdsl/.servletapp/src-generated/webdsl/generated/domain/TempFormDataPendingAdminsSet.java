...
@SuppressWarnings("unchecked")public class TempFormDataPendingAdminsSet extends utils.OwnedSet<webdsl.generated.domain.User>{
public  TempFormDataPendingAdminsSet(){
super();
}
public  TempFormDataPendingAdminsSet(int anticipatedSize){
super(anticipatedSize);
}
public  TempFormDataPendingAdminsSet(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  TempFormDataPendingAdminsSet(Object owner){
super(owner);
}
public  TempFormDataPendingAdminsSet(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  TempFormDataPendingAdminsSet(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
...
if(!contains(item)){
owner.removeFromPendingAdminsUser_(item);
}
beingSet=false;
return result;
}
