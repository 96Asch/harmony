...
import javax.persistence.*;import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_SongKey")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class SongKey implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static SongKey _static_createEmpty_(){
SongKey ent=new SongKey();
ent.setId(java.util.UUID.randomUUID());
return ent;
}
public static SongKey _static_cast_(Object o){
return (SongKey)org.webdsl.tools.Utils.cast(o,SongKey.class);
}
public  SongKey(){}
...
thepage.invalidateAllPageCache("SongKey"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"SongKey"+"."+prop);
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("SongKey")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?SongKey.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):SongKey.class.cast(o)).getId(),getId());
}
public SongKey save(String webdslTypeName){
setVersion(1);
...
return getId().compareTo(((SongKey)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("SongKey")||s.equals("Object")||s.equals("Entity");
}
...
public SongKey setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public SongKey setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public SongKey setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged("name");
...
return utils.HibernateUtil.getCurrentSession().createQuery("from SongKey").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from SongKey").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.SongKey> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SongKey as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.SongKey> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from SongKey as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.SongKey _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.SongKey._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"SongKey",prop_));
}
public webdsl.generated.domain.SongKey SongKey$this_(){
this.SongKey_();
return this;
}
public void SongKey_(){}
