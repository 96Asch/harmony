...
@SuppressWarnings("unchecked")public class TempFormDataAdminsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataAdminsSet(anticipatedSize<1?0:anticipatedSize);
}
