...
@SuppressWarnings("unchecked")public class TempFormDataSetlistsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataSetlistsSet(anticipatedSize<1?0:anticipatedSize);
}
