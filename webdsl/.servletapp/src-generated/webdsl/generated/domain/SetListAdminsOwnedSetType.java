...
@SuppressWarnings("unchecked")public class SetListAdminsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new SetListAdminsSet(anticipatedSize<1?0:anticipatedSize);
}
