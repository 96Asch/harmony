...
@SuppressWarnings("unchecked")public class TempFormDataSongsOwnedListType extends utils.AbstractOwnedListType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataSongsList(anticipatedSize<1?0:anticipatedSize);
}
