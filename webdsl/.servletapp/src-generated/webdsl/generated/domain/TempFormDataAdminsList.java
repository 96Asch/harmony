...
@SuppressWarnings("unchecked")public class TempFormDataAdminsList extends utils.OwnedList<webdsl.generated.domain.User>{
public  TempFormDataAdminsList(){
super();
}
public  TempFormDataAdminsList(int anticipatedSize){
super(anticipatedSize);
}
public  TempFormDataAdminsList(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  TempFormDataAdminsList(Object owner){
super(owner);
}
public  TempFormDataAdminsList(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  TempFormDataAdminsList(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
