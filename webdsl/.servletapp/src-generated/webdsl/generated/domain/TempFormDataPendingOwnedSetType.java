...
@SuppressWarnings("unchecked")public class TempFormDataPendingOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new TempFormDataPendingSet(anticipatedSize<1?0:anticipatedSize);
}
