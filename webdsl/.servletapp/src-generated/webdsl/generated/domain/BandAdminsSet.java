...
@SuppressWarnings("unchecked")public class BandAdminsSet extends utils.OwnedSet<webdsl.generated.domain.User>{
public  BandAdminsSet(){
super();
}
public  BandAdminsSet(int anticipatedSize){
super(anticipatedSize);
}
public  BandAdminsSet(java.util.List<webdsl.generated.domain.User> list){
super(list);
}
public  BandAdminsSet(Object owner){
super(owner);
}
public  BandAdminsSet(Object owner,int anticipatedSize){
super(owner,anticipatedSize);
}
public  BandAdminsSet(Object owner,java.util.List<webdsl.generated.domain.User> list){
super(owner,list);
}
