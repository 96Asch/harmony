...
import javax.persistence.*;import webdsl.generated.templates.*;public @javax.persistence.Entity @javax.persistence.Table(name="_ConfirmationType")@org.hibernate.annotations.Cache(usage=org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)@org.hibernate.annotations.FilterDefs({})@org.hibernate.annotations.Persister(impl=utils.SingleTableEntityPersister.class)@javax.persistence.DiscriminatorColumn(name="DISCRIMINATOR",discriminatorType=javax.persistence.DiscriminatorType.STRING,length=255)@SuppressWarnings("all")class ConfirmationType implements org.webdsl.WebDSLEntity,org.hibernate.bytecode.javassist.FieldHandled,org.webdsl.search.NoDynamicSearchFields{
...
public static ConfirmationType _static_createEmpty_(){
ConfirmationType ent=new ConfirmationType();
ent.setId(java.util.UUID.randomUUID());
return ent;
}
public static ConfirmationType _static_cast_(Object o){
return (ConfirmationType)org.webdsl.tools.Utils.cast(o,ConfirmationType.class);
}
...
thepage.invalidateAllPageCache("ConfirmationType"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"ConfirmationType"+"."+prop);
...
return o!=null&&o instanceof org.webdsl.WebDSLEntity&&((org.webdsl.WebDSLEntity)o).instanceOf("ConfirmationType")&&org.webdsl.tools.Utils.equal((o instanceof org.hibernate.proxy.HibernateProxy?ConfirmationType.class.cast(((org.hibernate.proxy.HibernateProxy)o).getHibernateLazyInitializer().getImplementation()):ConfirmationType.class.cast(o)).getId(),getId());
}
public ConfirmationType save(String webdslTypeName){
setVersion(1);
...
public ConfirmationType delete(){
validateDelete();
setChanged("delete()");
...
return getId().compareTo(((ConfirmationType)o).getId());
}
public boolean isInstance(Class<?> c){
return c.isInstance(this);
}
public boolean instanceOf(String s){
return s.equals("ConfirmationType")||s.equals("Object")||s.equals("Entity");
}
...
public ConfirmationType setCreated(java.util.Date newitem){
if(!createdBeingSet){
...
public ConfirmationType setModified(java.util.Date newitem){
if(!modifiedBeingSet){
...
public ConfirmationType setName(String newitem){
if(!nameBeingSet){
nameBeingSet=true;
setChanged("name");
...
return utils.HibernateUtil.getCurrentSession().createQuery("from ConfirmationType").setCacheable(true).list();
}
public java.util.List<org.webdsl.WebDSLEntity> all_(){
return utils.HibernateUtil.getCurrentSession().createQuery("from ConfirmationType").setCacheable(true).list();
}
public static java.util.List<webdsl.generated.domain.ConfirmationType> _static_findByName_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from ConfirmationType as g where g._name = :param0").setCacheable(true).setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.ConfirmationType> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from ConfirmationType as g where g._name like :param1").setCacheable(true).setParameter("param1",s_).list();
}
public static webdsl.generated.domain.ConfirmationType _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.ConfirmationType._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"ConfirmationType",prop_));
}
public webdsl.generated.domain.ConfirmationType ConfirmationType$this_(){
this.ConfirmationType_();
return this;
}
public void ConfirmationType_(){}
