...
@SuppressWarnings("unchecked")public class BandAdminsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new BandAdminsSet(anticipatedSize<1?0:anticipatedSize);
}
