...
public class SongsLSongL_Placeholder_ia0 extends utils.TemplateAction{
...
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("AddSongModal").getPageClass().newInstance()).serveAsAjaxResponse(args1,utils.TemplateCall.None,utils.URLFilter.filter(ph__));
}
catch(Exception iae){
