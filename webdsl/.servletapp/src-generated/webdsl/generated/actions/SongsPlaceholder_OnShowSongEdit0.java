...
public class SongsPlaceholder_OnShowSongEdit0 extends utils.TemplateAction{
public static boolean isValidationDisabled(){
return false;
}
public void run(final utils.AbstractPageServlet threadLocalPageCached,final org.webdsl.lang.Environment env,final String elementsContext,final webdsl.generated.domain.Song s_arg,final String p_arg,final String actionident){
...
Object[] args1=new Object[]{s_};
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("EditSongModalSong").getPageClass().newInstance()).serveAsAjaxResponse(args1,utils.TemplateCall.None,utils.URLFilter.filter(p_));
}
catch(Exception iae){
