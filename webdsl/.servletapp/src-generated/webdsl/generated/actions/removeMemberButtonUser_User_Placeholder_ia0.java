...
editor_=editor_arg;
if(webdsl.generated.functions.genactionpredicate_removeMemberButton__0User_User_Placeholder_.genactionpredicate_removeMemberButton__0User_User_Placeholder_(editor_,user_,ph_)){
...
Object[] args1=new Object[]{editor__,"",ph__};
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("userSearchUser_String_Placeholder").getPageClass().newInstance()).serveAsAjaxResponse(args1,utils.TemplateCall.None,utils.URLFilter.filter(ph__));
}
catch(Exception iae){
