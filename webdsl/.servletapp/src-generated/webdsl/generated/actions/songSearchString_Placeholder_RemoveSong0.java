...
public class songSearchString_Placeholder_RemoveSong0 extends utils.TemplateAction{
public static boolean isValidationDisabled(){
return false;
}
public void run(final utils.AbstractPageServlet threadLocalPageCached,final org.webdsl.lang.Environment env,final String elementsContext,final java.util.Set<webdsl.generated.domain.User> editors_arg,final webdsl.generated.domain.Song song_arg,final String ph_arg,final String actionident){
...
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("songSearchString_Placeholder").getPageClass().newInstance()).serveAsAjaxResponse(args1,utils.TemplateCall.None,utils.URLFilter.filter(ph_));
}
catch(Exception iae){
