...
public class LoginPlaceholder_ia1 extends utils.TemplateAction{
...
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("RegisterPlaceholder").getPageClass().newInstance()).serveAsAjaxResponse(args0,utils.TemplateCall.None,utils.URLFilter.filter(ph__));
}
catch(Exception iae){
org.webdsl.logging.Logger.error("Problem in template servlet template lookup for Ajax: "+iae.getMessage()+" template :"+"RegisterPlaceholder");
}
