...
public class userSearchString_SetList_LUserL_Placeholder_ia0 extends utils.TemplateAction{
public static boolean isValidationDisabled(){
return false;
}
public void run(final utils.AbstractPageServlet threadLocalPageCached,final org.webdsl.lang.Environment env,final String elementsContext,final utils.RefArg newQuery__,final String ph__arg,final java.util.List<webdsl.generated.domain.User> users__arg,final webdsl.generated.domain.SetList setlist__arg,final utils.RefArg newQuery_,final String actionident){
...
Object[] args1=new Object[]{(String)newQuery_.get(),setlist__,users__,ph__};
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("userSearchString_SetList_LUserL_Placeholder").getPageClass().newInstance()).serveAsAjaxResponse(args1,utils.TemplateCall.None,utils.URLFilter.filter(ph__));
}
catch(Exception iae){
