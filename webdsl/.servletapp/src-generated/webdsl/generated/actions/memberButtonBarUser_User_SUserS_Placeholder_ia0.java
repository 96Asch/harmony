...
public class memberButtonBarUser_User_SUserS_Placeholder_ia0 extends utils.TemplateAction{
public static boolean isValidationDisabled(){
return false;
}
public void run(final utils.AbstractPageServlet threadLocalPageCached,final org.webdsl.lang.Environment env,final String elementsContext,final String ph__arg,final java.util.Set<webdsl.generated.domain.User> pending__arg,final webdsl.generated.domain.User editor__arg,final String actionident){
...
Object[] args2=new Object[]{editor__,"",pending__,ph__};
try{
((utils.PageServlet)utils.DispatchServletHelper.pages.get("userSearchUser_String_SUserS_Placeholder").getPageClass().newInstance()).serveAsAjaxResponse(args2,utils.TemplateCall.None,utils.URLFilter.filter(ph__));
}
catch(Exception iae){
