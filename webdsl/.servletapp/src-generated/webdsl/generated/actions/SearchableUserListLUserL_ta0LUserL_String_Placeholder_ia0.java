...
public class SearchableUserListLUserL_ta0LUserL_String_Placeholder_ia0 extends utils.TemplateAction{
public static boolean isValidationDisabled(){
return false;
}
public void run(final utils.AbstractPageServlet threadLocalPageCached,final org.webdsl.lang.Environment env,final String elementsContext,final String ph__arg,final utils.RefArg query__,final java.util.List<webdsl.generated.domain.User> users__arg,final String actionident){
