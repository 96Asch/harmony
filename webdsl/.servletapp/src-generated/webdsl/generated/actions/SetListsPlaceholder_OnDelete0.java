...
public class SetListsPlaceholder_OnDelete0 extends utils.TemplateAction{
...
public void run(){
utils.ThreadLocalPage.get().setRedirectUrl(utils.Navigate.constructUrl("RemoveSetlists"));
}
}
);
}
