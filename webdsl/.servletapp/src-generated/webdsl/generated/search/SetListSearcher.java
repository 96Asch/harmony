...
public class SetListSearcher extends org.webdsl.search.AbstractEntitySearcher<webdsl.generated.domain.SetList,SetListSearcher>{
private static Analyzer _analyzer;
private static Analyzer _highlightAnalyzer;
private static BoboIndexReader _boboReader;
static {
_highlightAnalyzer=org.hibernate.search.Search.getFullTextSession(utils.HibernateUtil.getCurrentSession()).getSearchFactory().getAnalyzer(webdsl.generated.domain.SetList.class);
_analyzer=org.hibernate.search.Search.getFullTextSession(utils.HibernateUtil.getCurrentSession()).getSearchFactory().getAnalyzer(webdsl.generated.domain.SetList.class);
}
public  SetListSearcher(){
entityClass=webdsl.generated.domain.SetList.class;
analyzer=_analyzer;
...
public static SetListSearcher fromString(String str){
return (SetListSearcher)fromParamMap(utils.URLFilter.URLEncodingToParamMap(str));
}
public boolean instanceOf(String s){
return s.equals("SetListSearcher");
}
...
String baseDir=IndexManager.indexDirSpellCheck(webdsl.generated.domain.SetList.class,"",namespace);
return SearchSuggester.findSpellSuggestions(webdsl.generated.domain.SetList.class,baseDir,fields,noSug,accuracy,true,_analyzer,toSuggestOn);
}
...
String baseDir=IndexManager.indexDirSpellCheck(webdsl.generated.domain.SetList.class,"",namespace);
return SearchSuggester.findSpellSuggestionsForField(webdsl.generated.domain.SetList.class,baseDir,field,noSug,accuracy,true,_analyzer,toSuggestOn);
}
...
String baseDir=IndexManager.indexDirAutoComplete(webdsl.generated.domain.SetList.class,"",namespace);
return SearchSuggester.findAutoCompletions(webdsl.generated.domain.SetList.class,baseDir,fields,noSug,_analyzer,toSuggestOn);
}
public static java.util.ArrayList<String> autoCompleteSuggest(String toSuggestOn,String namespace,String field,int noSug){
String baseDir=IndexManager.indexDirAutoComplete(webdsl.generated.domain.SetList.class,"",namespace);
return SearchSuggester.findAutoCompletionsForField(webdsl.generated.domain.SetList.class,baseDir,field,noSug,_analyzer,toSuggestOn);
}
public Class<?> fieldType(String field){
return String.class;
}
public SetListSearcher reset(){
clearFacetSelection();
clearFieldFilters();
clearSorting();
removeNamespace();
...
org.webdsl.logging.Logger.info("renewing faceting index reader for entity "+"SetList");
...
DirectoryProvider<?>[] providers=searchFactory.getDirectoryProviders(webdsl.generated.domain.SetList.class);
try{
