...
if(entities==null||entities.isEmpty()||entities.contains("SetList")||entities.contains("webdsl.generated.domain.SetList")){
reindexEntityClass(webdsl.generated.domain.SetList.class);
}
if(entities==null||entities.isEmpty()||entities.contains("Song")||entities.contains("webdsl.generated.domain.Song")){
reindexEntityClass(webdsl.generated.domain.Song.class);
}
if(entities==null||entities.isEmpty()||entities.contains("User")||entities.contains("webdsl.generated.domain.User")){
reindexEntityClass(webdsl.generated.domain.User.class);
}
...
SetListSearcher.closeBoboReader();
SongSearcher.closeBoboReader();
UserSearcher.closeBoboReader();
dummy_webdsl_entitySearcher.closeBoboReader();
lastFacetReaderRenewal=0l;
}
private static void renewFacetIndexReadersInternal(){
if(getModifiedTimeIndex(SetList.class)>lastFacetReaderRenewal){
SetListSearcher.tryRenewBoboReader();
}
if(getModifiedTimeIndex(Song.class)>lastFacetReaderRenewal){
SongSearcher.tryRenewBoboReader();
}
if(getModifiedTimeIndex(User.class)>lastFacetReaderRenewal){
UserSearcher.tryRenewBoboReader();
}
...
if(webdsl.generated.domain.SetList.class.equals(entityClass)){
return "webdsl.generated.domain.SetList";
}
if(webdsl.generated.domain.Song.class.equals(entityClass)){
return "webdsl.generated.domain.Song";
}
if(webdsl.generated.domain.User.class.equals(entityClass)){
return "webdsl.generated.domain.User";
}
