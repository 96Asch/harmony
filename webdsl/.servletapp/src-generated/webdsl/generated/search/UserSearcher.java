...
searchFields=defaultSearchFields=new String[]{"email","username"};
untokenizedFields=new String[]{};
mltSearchFields=new String[]{"email","username"};
rootQD=parentQD=currentQD=new QueryDef(Occur.SHOULD,new String[]{"email","username"});
}
