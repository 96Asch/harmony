...
@SuppressWarnings("all")public class AddSongModal_Template extends utils.TemplateServlet{
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.AddSongModal_s_ad0String_Song_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(AddSongModal_s_ad0String_Song_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"AddSongModal":keyOverwrite,AddSongModal_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(AddSongModal_Template.class);
return staticEnv;
}
...
return "ajaxtemplate AddSongModal()";
}
...
utils.TemplateCall.appendWithPadding(classattrs,"modal-header border-3 d-flex justify-content-center front");
utils.TemplateCall.printClassStyleAttributes(classattrs,styleattrs,out);
}
out.print(">");
}
...
if(RENDER_PHASE==phase){
utils.RenderUtils.printPageString("Add Song",out,threadLocalPageCached.isRawoutput());
}
if(RENDER_PHASE==phase){
out.print("</"+"h3"+">");
}
...
utils.TemplateCall.appendWithPadding(classattrs,"modal-body front");
utils.TemplateCall.printClassStyleAttributes(classattrs,styleattrs,out);
}
out.print(">");
}
...
ident=(inForLoop?forelementid:"")+("form142082340"+getUniqueId());
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall142082342","SongFieldsSong",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_},"SongFieldsSong"),new org.webdsl.lang.Environment(env).putWithcall("elements#SongFieldsSong",utils.TemplateCall.EmptyElementsCall),"SongFieldsSong",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SongFieldsSong(song) at dashmodal.app:99/14");
}
if(RENDER_PHASE==phase){
out.print("<"+"div");
{
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall142082344","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"AddSongModal_OnSongSave1"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("AddSongModal_s_ad0String_Song",getElementsContext(),new Object[]{new webdsl.generated.templates.RefArg_AddSongModal_Template0(AddSongModal_Template.this)},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"AddSongModal_OnSongSave1\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
...
utils.TemplateCall.appendWithPadding(classattrs,"col-12 col-md-8");
utils.TemplateCall.printClassStyleAttributes(classattrs,styleattrs,out);
}
out.print(">");
}
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall142082347","SongViewSong",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_},"SongViewSong"),new org.webdsl.lang.Environment(env).putWithcall("elements#SongViewSong",utils.TemplateCall.EmptyElementsCall),"SongViewSong",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SongViewSong(song) at dashmodal.app:109/14");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
...
song_=webdsl.generated.domain.Song._static_createEmpty_().Song$this_().setOwner(((webdsl.generated.domain.SecurityContext)utils.ThreadLocalPage.getEnv().getSessionVariable("securityContext")).getPrincipal());
}
}
