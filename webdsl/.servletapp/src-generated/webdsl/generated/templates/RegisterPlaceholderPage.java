...
@SuppressWarnings("all")public class RegisterPlaceholderPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{ph_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new RegisterPlaceholder_Template();
}
