...
@SuppressWarnings("all")public class UserSearchString_LUserL_PlaceholderPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{query_,users_,ph_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new userSearchString_LUserL_Placeholder_Template();
}
