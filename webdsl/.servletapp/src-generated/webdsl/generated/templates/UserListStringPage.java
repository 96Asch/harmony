...
@SuppressWarnings("all")public class UserListStringPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{query_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new UserListString_Template();
}
