...
@SuppressWarnings("all")public class userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0String_String_User_String_Placeholder_User_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0String_String_User_String_Placeholder_User":keyOverwrite,userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0String_String_User_String_Placeholder_User_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0String_String_User_String_Placeholder_User_Template.class);
return staticEnv;
}
...
return "userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0String_String_User_String_Placeholder_User";
}
public String getTemplateSignature(){
return "template userSearchUser_String_Placeholder_s_ad0String_User_String_Placeholder_User_s_ad0(userSearchUser_String_Placeholder_AddUser24 : String, userSearchUser_String_Placeholder_AddUser10 : String, owner : User, query : String, ph : Placeholder, user : User)";
}
...
private static String c$81(webdsl.generated.domain.User user__){
try{
...
private static String c$82(webdsl.generated.domain.User user__){
try{
Object v=user__.getUsername();
if(v==null){
return "";
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall2234776320","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{""+c$81(user_)},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(\"~user.username\") at usersearch.app:119/25");
}
if(RENDER_PHASE==phase){
out.print("</"+"span"+">");
}
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall2234776320","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{""+c$82(user_)},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(\"~user.username\") at usersearch.app:119/25");
}
