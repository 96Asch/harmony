...
@SuppressWarnings("all")public class EditSetListModalSetList_s_ad0String_SetList_LUserL_LSongL_Bool_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"EditSetListModalSetList_s_ad0String_SetList_LUserL_LSongL_Bool":keyOverwrite,EditSetListModalSetList_s_ad0String_SetList_LUserL_LSongL_Bool_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(EditSetListModalSetList_s_ad0String_SetList_LUserL_LSongL_Bool_Template.class);
return staticEnv;
}
...
return "EditSetListModalSetList_s_ad0String_SetList_LUserL_LSongL_Bool";
}
public String getTemplateSignature(){
return "template EditSetListModalSetList_s_ad0(EditSetListModalSetList_ia00 : String, setlist : SetList, eligibleUsers : ref [User], eligibleSongs : ref [Song], valid : ref Bool)";
}
...
new webdsl.generated.actions.EditSetListModalSetList_ia0().run(threadLocalPageCached,getEnv(),getElementsContext(),(Boolean)valid_.get(),setlist_,ident);
}
