...
@SuppressWarnings("all")public class NotificationsLNotificationL_Template extends utils.TemplateServlet{
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"NotificationsLNotificationL":keyOverwrite,NotificationsLNotificationL_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(NotificationsLNotificationL_Template.class);
return staticEnv;
}
...
return "NotificationsLNotificationL";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_11501480320"+forelementid))==null){
if0=!(org.webdsl.tools.Utils.equal(notifications_.size(),null)||org.webdsl.tools.Utils.equal(0,null))&&notifications_.size()>0;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if_11501480320"+forelementid,if0);
}
}
if(if0){
if(RENDER_PHASE==phase){
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.Notification>)getTemplatecalls().get("for_11501480320"+forelementid))==null){
...
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for_11501480320"+forelementid,forcol0);
}
}
int i0=-1;
