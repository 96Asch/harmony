...
@SuppressWarnings("all")public class RefArg_inputLEntityL_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0 extends utils.RefArg{
public webdsl.generated.domain.Band band_;
public  RefArg_inputLEntityL_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0(){}
public  RefArg_inputLEntityL_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0(Object band_){
this.band_=(webdsl.generated.domain.Band)band_;
}
public webdsl.generated.domain.Band set(Object obj){
band_.replaceAllInAdmins((java.util.List<webdsl.generated.domain.User>)obj);
return band_;
}
public Object get(){
return (java.util.List<webdsl.generated.domain.User>)band_.getAdmins();
}
...
return band_.getId()+"!"+"RefArg_inputLEntityL_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0";
}
...
band_.validateAdmins_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Band").getPropertyByName("admins");
}
