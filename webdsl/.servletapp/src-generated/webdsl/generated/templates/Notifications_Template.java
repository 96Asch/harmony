...
@SuppressWarnings("all")public class Notifications_Template extends utils.TemplateServlet{
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"Notifications":keyOverwrite,Notifications_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(Notifications_Template.class);
return staticEnv;
}
...
private java.util.List<webdsl.generated.domain.Notification> notifications_;
public java.util.List<webdsl.generated.domain.Notification> getNotifications_(){
return notifications_;
}
public void setNotifications_(java.util.List<webdsl.generated.domain.Notification> notifications_){
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_20164497310"+forelementid))==null){
if0=!(org.webdsl.tools.Utils.equal(notifications_.size(),null)||org.webdsl.tools.Utils.equal(0,null))&&notifications_.size()>0;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if_20164497310"+forelementid,if0);
}
}
if(if0){
if(RENDER_PHASE==phase){
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.Notification>)getTemplatecalls().get("for_20164497310"+forelementid))==null){
...
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for_20164497310"+forelementid,forcol0);
}
}
int i0=-1;
...
Boolean if1=null;
if(RENDER_PHASE==phase||(if1=(Boolean)getTemplatecalls().get("if_20164497311"+forelementid))==null){
if1=org.webdsl.tools.Utils.instanceOf(notification_,"SetListInvitation");
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if_20164497311"+forelementid,if1);
}
}
if(if1){
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_20164497310","NotificationContentSetListInvitation",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{webdsl.generated.domain.SetListInvitation._static_cast_(notification_)},"NotificationContentSetListInvitation"),new org.webdsl.lang.Environment(env).putWithcall("elements#NotificationContentSetListInvitation",utils.TemplateCall.EmptyElementsCall),"NotificationContentSetListInvitation",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"NotificationContentSetListInvitation(( notification as SetListInvitation )) at dashboard.app:87/15");
}
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
...
notifications_=utils.HibernateUtil.getCurrentSession().createQuery("from Notification as n where n._receiver._username = :param0").setParameter("param0",username_).list();
}
}
