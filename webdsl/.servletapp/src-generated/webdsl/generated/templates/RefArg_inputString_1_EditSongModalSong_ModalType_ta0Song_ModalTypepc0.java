...
@SuppressWarnings("all")public class RefArg_inputString_1_EditSongModalSong_ModalType_ta0Song_ModalTypepc0 extends utils.RefArg{
public webdsl.generated.domain.Song song_;
public  RefArg_inputString_1_EditSongModalSong_ModalType_ta0Song_ModalTypepc0(){}
public  RefArg_inputString_1_EditSongModalSong_ModalType_ta0Song_ModalTypepc0(Object song_){
this.song_=(webdsl.generated.domain.Song)song_;
}
public webdsl.generated.domain.Song set(Object obj){
song_.setTitle((String)org.webdsl.tools.Utils.cast(obj,String.class));
return song_;
}
public Object get(){
return (String)song_.getTitle();
}
...
return song_.getId()+"!"+"RefArg_inputString_1_EditSongModalSong_ModalType_ta0Song_ModalTypepc0";
}
...
song_.validateTitle_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Song").getPropertyByName("title");
}
