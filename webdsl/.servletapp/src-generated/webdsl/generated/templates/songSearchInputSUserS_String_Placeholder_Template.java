...
@SuppressWarnings("all")public class songSearchInputSUserS_String_Placeholder_Template extends utils.TemplateServlet{
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.songSearchInputSUserS_String_Placeholder_ta0SUserS_String_Placeholder_String_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(songSearchInputSUserS_String_Placeholder_ta0SUserS_String_Placeholder_String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"songSearchInputSUserS_String_Placeholder":keyOverwrite,songSearchInputSUserS_String_Placeholder_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(songSearchInputSUserS_String_Placeholder_Template.class);
return staticEnv;
}
...
return "template songSearchInput(editors : {User}, query : String, ph : Placeholder)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_20637865820"+forelementid))==null){
...
getTemplatecalls().put("if_20637865820"+forelementid,if0);
}
}
if(if0){
...
ident=(inForLoop?forelementid:"")+("form_20637865820"+getUniqueId());
...
handleTemplateCall(phase,inForLoop,forelementid,"tcall_20637865822","labelString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"Add a song:"},"labelString"),new org.webdsl.lang.Environment(env).putWithcall("elements#labelString",new utils.TemplateCall("songSearchInputSUserS_String_Placeholder_ta0SUserS_String_Placeholder_String",getElementsContext(),new Object[]{editors_,query_,ph_,new webdsl.generated.templates.RefArg_songSearchInputSUserS_String_Placeholder_Template0(songSearchInputSUserS_String_Placeholder_Template.this)},attrs)),"labelString",attrsmapout);
}
