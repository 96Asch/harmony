...
@SuppressWarnings("all")public class userSearchInputUser_String_SUserS_Placeholder_Template extends utils.TemplateServlet{
...
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.userSearchInputUser_String_SUserS_Placeholder_ta0User_String_SUserS_Placeholder_String_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(userSearchInputUser_String_SUserS_Placeholder_ta0User_String_SUserS_Placeholder_String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"userSearchInputUser_String_SUserS_Placeholder":keyOverwrite,userSearchInputUser_String_SUserS_Placeholder_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(userSearchInputUser_String_SUserS_Placeholder_Template.class);
return staticEnv;
}
...
return "template userSearchInput(editor : User, query : String, pending : {User}, ph : Placeholder)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_16675111270"+forelementid))==null){
...
getTemplatecalls().put("if_16675111270"+forelementid,if0);
}
}
if(if0){
...
ident=(inForLoop?forelementid:"")+("form_16675111270"+getUniqueId());
...
handleTemplateCall(phase,inForLoop,forelementid,"tcall_16675111272","labelString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"Add a member:"},"labelString"),new org.webdsl.lang.Environment(env).putWithcall("elements#labelString",new utils.TemplateCall("userSearchInputUser_String_SUserS_Placeholder_ta0User_String_SUserS_Placeholder_String",getElementsContext(),new Object[]{editor_,query_,pending_,ph_,new webdsl.generated.templates.RefArg_userSearchInputUser_String_SUserS_Placeholder_Template0(userSearchInputUser_String_SUserS_Placeholder_Template.this)},attrs)),"labelString",attrsmapout);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"labelString(\"Add a member:\") at usersearch.app:80/6");
}
}
if(RENDER_PHASE==phase){
out.print("</form>");
