...
@SuppressWarnings("all")public class slSearchInputUser_String_Placeholder_Template extends utils.TemplateServlet{
...
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.slSearchInputUser_String_Placeholder_ta0User_String_Placeholder_String_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(slSearchInputUser_String_Placeholder_ta0User_String_Placeholder_String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"slSearchInputUser_String_Placeholder":keyOverwrite,slSearchInputUser_String_Placeholder_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(slSearchInputUser_String_Placeholder_Template.class);
return staticEnv;
}
...
return "template slSearchInput(editor : User, query : String, ph : Placeholder)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if10443867710"+forelementid))==null){
...
getTemplatecalls().put("if10443867710"+forelementid,if0);
}
}
if(if0){
...
ident=(inForLoop?forelementid:"")+("form10443867710"+getUniqueId());
...
handleTemplateCall(phase,inForLoop,forelementid,"tcall10443867712","labelString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"Enter the setlist to remove:"},"labelString"),new org.webdsl.lang.Environment(env).putWithcall("elements#labelString",new utils.TemplateCall("slSearchInputUser_String_Placeholder_ta0User_String_Placeholder_String",getElementsContext(),new Object[]{editor_,query_,ph_,new webdsl.generated.templates.RefArg_slSearchInputUser_String_Placeholder_Template0(slSearchInputUser_String_Placeholder_Template.this)},attrs)),"labelString",attrsmapout);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"labelString(\"Enter the setlist to remove:\") at setlistsearch.app:11/6");
}
}
if(RENDER_PHASE==phase){
out.print("</form>");
