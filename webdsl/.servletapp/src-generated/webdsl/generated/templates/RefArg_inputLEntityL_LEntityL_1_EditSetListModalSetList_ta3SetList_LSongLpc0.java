...
@SuppressWarnings("all")public class RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta3SetList_LSongLpc0 extends utils.RefArg{
public webdsl.generated.domain.SetList setlist_;
public  RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta3SetList_LSongLpc0(){}
public  RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta3SetList_LSongLpc0(Object setlist_){
this.setlist_=(webdsl.generated.domain.SetList)setlist_;
}
public webdsl.generated.domain.SetList set(Object obj){
setlist_.replaceAllInSongs((java.util.List<webdsl.generated.domain.Song>)obj);
return setlist_;
}
public Object get(){
return (java.util.List<webdsl.generated.domain.Song>)setlist_.getSongs();
}
...
return setlist_.getId()+"!"+"RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta3SetList_LSongLpc0";
}
...
setlist_.validateSongs_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("SetList").getPropertyByName("songs");
}
