...
@SuppressWarnings("all")public class SongsPlaceholder_s_ad1String_Placeholder_String_LSongL_Song_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"SongsPlaceholder_s_ad1String_Placeholder_String_LSongL_Song":keyOverwrite,SongsPlaceholder_s_ad1String_Placeholder_String_LSongL_Song_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(SongsPlaceholder_s_ad1String_Placeholder_String_LSongL_Song_Template.class);
return staticEnv;
}
...
return "SongsPlaceholder_s_ad1String_Placeholder_String_LSongL_Song";
}
public String getTemplateSignature(){
return "template SongsPlaceholder_s_ad1(SongsPlaceholder_OnShowSongEdit10 : String, ph : Placeholder, username : ref String, songs : ref [Song], song : Song)";
}
...
out.print(">");
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_12160202830","SongCardSong",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_},"SongCardSong"),new org.webdsl.lang.Environment(env).putWithcall("elements#SongCardSong",utils.TemplateCall.EmptyElementsCall),"SongCardSong",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SongCardSong(song) at dashboard.app:323/14");
}
out.print("</a>");
}
else {
