...
@SuppressWarnings("all")public class userSearchLUserL_Placeholder_Template extends utils.TemplateServlet{
...
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.userSearchLUserL_Placeholder_s_ad1String_LUserL_Placeholder_Placeholder_String_User_Template.class,null,utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.userSearchLUserL_Placeholder_s_ad0String_LUserL_Placeholder_Placeholder_String_Template.class,null,staticEnv));
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(userSearchLUserL_Placeholder_s_ad0String_LUserL_Placeholder_Placeholder_String_Template.class);
utils.AbstractPageServlet.loadRefArgClasses(userSearchLUserL_Placeholder_s_ad1String_LUserL_Placeholder_Placeholder_String_User_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"userSearchLUserL_Placeholder":keyOverwrite,userSearchLUserL_Placeholder_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(userSearchLUserL_Placeholder_Template.class);
return staticEnv;
}
...
return "ajaxtemplate userSearch(users : [User], ph : Placeholder)";
}
...
ident=(inForLoop?forelementid:"")+("form280834870"+getUniqueId());
...
String actionid0=(inForLoop?forelementid:"")+("action280834870"+getUniqueId());
if(threadLocalPageCached.getParammap().get(actionid0)!=null){
threadLocalPageCached.actionToBeExecutedHasDisabledValidation=webdsl.generated.actions.userSearchLUserL_Placeholder_ia0.isValidationDisabled();
}
}
if(ACTION_PHASE==phase){
String actionid1=(inForLoop?forelementid:"")+("action280834870"+getUniqueId());
if(threadLocalPageCached.getParammap().get(actionid1)!=null){
threadLocalPageCached.enableAjaxActionExecuted();
new webdsl.generated.actions.userSearchLUserL_Placeholder_ia0().run(threadLocalPageCached,getEnv(),getElementsContext(),results_,ident);
return;}
}
java.util.Map<String,String> attrsmapout=new java.util.HashMap<String,String>();
utils.TemplateCall.putAttributeMergeClassOrStyle(attrsmapout,"oninput","serverInvoke(\""+threadLocalPageCached.getAbsoluteLocation()+"/"+threadLocalPageCached.getActionTarget()+"\",\""+((inForLoop?forelementid:"")+("action280834870"+getUniqueId()))+"\", ["+threadLocalPageCached.getHiddenPostParamsJson()+"],\""+threadLocalPageCached.getFormIdent()+"\", this, "+"false"+",\""+threadLocalPageCached.placeholderId+"\");");
handleTemplateCall(phase,inForLoop,forelementid,"tcall280834870","inputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{new webdsl.generated.templates.RefArg_userSearchLUserL_Placeholder_Template0(userSearchLUserL_Placeholder_Template.this)},"inputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#inputString",utils.TemplateCall.EmptyElementsCall),"inputString",attrsmapout);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"inputString(newQuery) at dashmodal.app:288/6");
}
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall280834872","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"userSearchLUserL_Placeholder_ia1_"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("userSearchLUserL_Placeholder_s_ad0String_LUserL_Placeholder_Placeholder_String",getElementsContext(),new Object[]{users_,ph_,results_,new webdsl.generated.templates.RefArg_userSearchLUserL_Placeholder_Template0(userSearchLUserL_Placeholder_Template.this)},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"userSearchLUserL_Placeholder_ia1\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
}
if(RENDER_PHASE==phase){
out.print("</form>");
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.User>)getTemplatecalls().get("for280834870"+forelementid))==null){
...
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for280834870"+forelementid,forcol0);
}
}
int i0=-1;
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall280834875","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"userSearchLUserL_Placeholder_ia2_"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("userSearchLUserL_Placeholder_s_ad1String_LUserL_Placeholder_Placeholder_String_User",getElementsContext(),new Object[]{users_,ph_,results_,new webdsl.generated.templates.RefArg_userSearchLUserL_Placeholder_Template0(userSearchLUserL_Placeholder_Template.this),m_},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"userSearchLUserL_Placeholder_ia2\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
...
if(RENDER_PHASE==phase||(forcol1=(java.util.List<webdsl.generated.domain.User>)getTemplatecalls().get("for280834871"+forelementid))==null){
...
forcol1=list2;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for280834871"+forelementid,forcol1);
}
}
int i1=-1;
for(webdsl.generated.domain.User userSearchLUserL_Placeholder_outputlist0_:forcol1){
i1++;
fallbackcounter+=1;
if(org.webdsl.WebDSLEntity.class.isInstance(userSearchLUserL_Placeholder_outputlist0_)){
org.webdsl.WebDSLEntity temp1=(org.webdsl.WebDSLEntity)(Object)userSearchLUserL_Placeholder_outputlist0_;
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if280834870"+forelementid))==null){
if0=!org.webdsl.tools.Utils.equal(userSearchLUserL_Placeholder_outputlist0_,null);
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if280834870"+forelementid,if0);
}
}
if(if0){
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall280834878","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{userSearchLUserL_Placeholder_outputlist0_.getName()},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(userSearchLUserL_Placeholder_outputlist0.name) at unknown context");
}
}
if(RENDER_PHASE==phase){
out.print("</"+"li"+">");
