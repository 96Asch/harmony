...
@SuppressWarnings("all")public class EditBandModalBandPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{band_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new EditBandModalBand_Template();
}
