...
@SuppressWarnings("all")public class BandsLBandL_Template extends utils.TemplateServlet{
public void prefetchFor16619493730(java.util.List<webdsl.generated.domain.Band> list,boolean early){
if(early){}
else {}
}
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.BandsLBandL_s_ad0String_LBandL_Band_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(BandsLBandL_s_ad0String_LBandL_Band_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"BandsLBandL":keyOverwrite,BandsLBandL_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(BandsLBandL_Template.class);
return staticEnv;
}
...
return "template Bands(bands : [Band])";
}
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.Band>)getTemplatecalls().get("for_18787066970"+forelementid))==null){
...
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for_18787066970"+forelementid,forcol0);
}
}
int i0=-1;
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_18787066970","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"BandsLBandL_ia0_"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("BandsLBandL_s_ad0String_LBandL_Band",getElementsContext(),new Object[]{bands_,band_},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"BandsLBandL_ia0\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
