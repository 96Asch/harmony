...
@SuppressWarnings("all")public class SongsLSongL_Placeholder_s_ad1String_LSongL_Placeholder_Song_Song_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"SongsLSongL_Placeholder_s_ad1String_LSongL_Placeholder_Song_Song":keyOverwrite,SongsLSongL_Placeholder_s_ad1String_LSongL_Placeholder_Song_Song_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(SongsLSongL_Placeholder_s_ad1String_LSongL_Placeholder_Song_Song_Template.class);
return staticEnv;
}
...
return "SongsLSongL_Placeholder_s_ad1String_LSongL_Placeholder_Song_Song";
}
public String getTemplateSignature(){
return "template SongsLSongL_Placeholder_s_ad1(SongsLSongL_Placeholder_ia10 : String, songs : [Song], ph : Placeholder, newSong : ref Song, song : Song)";
}
...
new webdsl.generated.actions.SongsLSongL_Placeholder_ia1().run(threadLocalPageCached,getEnv(),getElementsContext(),(webdsl.generated.domain.Song)newSong_.get(),ph_,ident);
}
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_10968285560","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_.getTitle()},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(song.title) at dashboard.app:347/26");
}
if(RENDER_PHASE==phase){
out.print("</"+"h5"+">");
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_10968285560"+forelementid))==null){
if0=!org.webdsl.tools.Utils.equal(song_.getKey(),null);
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if_10968285560"+forelementid,if0);
}
}
if(if0){
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_10968285562","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_.getKey().getName()},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_10968285564","outputInt",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_.getBpm()},"outputInt"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputInt",utils.TemplateCall.EmptyElementsCall),"outputInt",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputInt(song.bpm) at dashboard.app:352/63");
}
if(RENDER_PHASE==phase){
out.print("</"+"span"+">");
}
