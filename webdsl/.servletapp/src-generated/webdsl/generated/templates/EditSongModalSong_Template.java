...
@SuppressWarnings("all")public class EditSongModalSong_Template extends utils.TemplateServlet{
...
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.EditSongModalSong_s_ad0String_Song_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(EditSongModalSong_s_ad0String_Song_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"EditSongModalSong":keyOverwrite,EditSongModalSong_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(EditSongModalSong_Template.class);
return staticEnv;
}
...
return "ajaxtemplate EditSongModal(song : Song)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if10562720650"+forelementid))==null){
...
getTemplatecalls().put("if10562720650"+forelementid,if0);
}
}
if(if0){
if(RENDER_PHASE==phase){
...
if(RENDER_PHASE==phase){
utils.RenderUtils.printPageString("Edit Song",out,threadLocalPageCached.isRawoutput());
}
if(RENDER_PHASE==phase){
out.print("</"+"h3"+">");
}
...
ident=(inForLoop?forelementid:"")+("form10562720650"+getUniqueId());
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall10562720652","SongFieldsSong",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_},"SongFieldsSong"),new org.webdsl.lang.Environment(env).putWithcall("elements#SongFieldsSong",utils.TemplateCall.EmptyElementsCall),"SongFieldsSong",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SongFieldsSong(song) at dashmodal.app:137/10");
}
if(RENDER_PHASE==phase){
out.print("<"+"div");
{
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall10562720654","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"EditSongModalSong_OnSongSave1"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("EditSongModalSong_s_ad0String_Song",getElementsContext(),new Object[]{song_},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"EditSongModalSong_OnSongSave1\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall10562720657","SongViewSong",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{song_},"SongViewSong"),new org.webdsl.lang.Environment(env).putWithcall("elements#SongViewSong",utils.TemplateCall.EmptyElementsCall),"SongViewSong",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SongViewSong(song) at dashmodal.app:146/12");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
