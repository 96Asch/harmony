...
@SuppressWarnings("all")public class RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta1SetList_LUserLpc0 extends utils.RefArg{
public webdsl.generated.domain.SetList setlist_;
public  RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta1SetList_LUserLpc0(){}
public  RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta1SetList_LUserLpc0(Object setlist_){
this.setlist_=(webdsl.generated.domain.SetList)setlist_;
}
public webdsl.generated.domain.SetList set(Object obj){
setlist_.replaceAllInMembers((java.util.List<webdsl.generated.domain.User>)obj);
return setlist_;
}
public Object get(){
return (java.util.List<webdsl.generated.domain.User>)setlist_.getMembers();
}
...
return setlist_.getId()+"!"+"RefArg_inputLEntityL_LEntityL_1_EditSetListModalSetList_ta1SetList_LUserLpc0";
}
...
setlist_.validateMembers_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("SetList").getPropertyByName("members");
}
