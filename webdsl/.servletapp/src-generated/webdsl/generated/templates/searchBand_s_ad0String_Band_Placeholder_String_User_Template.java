...
@SuppressWarnings("all")public class searchBand_s_ad0String_Band_Placeholder_String_User_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"searchBand_s_ad0String_Band_Placeholder_String_User":keyOverwrite,searchBand_s_ad0String_Band_Placeholder_String_User_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(searchBand_s_ad0String_Band_Placeholder_String_User_Template.class);
return staticEnv;
}
...
return "searchBand_s_ad0String_Band_Placeholder_String_User";
}
public String getTemplateSignature(){
return "template searchBand_s_ad0(searchBand_ia10 : String, band : Band, results : Placeholder, query : ref String, u : User)";
}
...
private static String c$21(webdsl.generated.domain.User u__){
try{
...
private static String c$22(webdsl.generated.domain.User u__){
try{
Object v=u__.getUsername();
if(v==null){
return "";
...
new webdsl.generated.actions.searchBand_ia1().run(threadLocalPageCached,getEnv(),getElementsContext(),u_,band_,ident);
}
...
out.print(">");
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_20374756810","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{""+c$21(u_)},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(\"~u.username\") at dashmodal.app:165/61");
}
out.print("</a>");
}
else {
...
out.print(">");
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_20374756810","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{""+c$22(u_)},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(\"~u.username\") at dashmodal.app:165/61");
}
