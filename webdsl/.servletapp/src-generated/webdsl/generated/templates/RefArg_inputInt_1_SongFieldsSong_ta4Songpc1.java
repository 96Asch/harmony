...
@SuppressWarnings("all")public class RefArg_inputInt_1_SongFieldsSong_ta4Songpc1 extends utils.RefArg{
public webdsl.generated.domain.Song song_;
public  RefArg_inputInt_1_SongFieldsSong_ta4Songpc1(){}
public  RefArg_inputInt_1_SongFieldsSong_ta4Songpc1(Object song_){
this.song_=(webdsl.generated.domain.Song)song_;
}
public webdsl.generated.domain.Song set(Object obj){
song_.setTimeSignature2((Integer)org.webdsl.tools.Utils.cast(obj,Integer.class));
return song_;
}
public Object get(){
return (Integer)song_.getTimeSignature2();
}
...
return song_.getId()+"!"+"RefArg_inputInt_1_SongFieldsSong_ta4Songpc1";
}
...
song_.validateTimeSignature2_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Song").getPropertyByName("timeSignature2");
}
