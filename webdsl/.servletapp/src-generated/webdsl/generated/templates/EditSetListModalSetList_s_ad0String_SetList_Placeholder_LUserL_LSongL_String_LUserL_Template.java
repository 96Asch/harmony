...
@SuppressWarnings("all")public class EditSetListModalSetList_s_ad0String_SetList_Placeholder_LUserL_LSongL_String_LUserL_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"EditSetListModalSetList_s_ad0String_SetList_Placeholder_LUserL_LSongL_String_LUserL":keyOverwrite,EditSetListModalSetList_s_ad0String_SetList_Placeholder_LUserL_LSongL_String_LUserL_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(EditSetListModalSetList_s_ad0String_SetList_Placeholder_LUserL_LSongL_String_LUserL_Template.class);
return staticEnv;
}
...
userList_=(utils.RefArg)args[6];
}
public String getUniqueName(){
return "EditSetListModalSetList_s_ad0String_SetList_Placeholder_LUserL_LSongL_String_LUserL";
}
public String getTemplateSignature(){
return "template EditSetListModalSetList_s_ad0(EditSetListModalSetList_ia00 : String, setlist : SetList, ph : Placeholder, eligibleUsers : ref [User], eligibleSongs : ref [Song], memberQuery : ref String, userList : ref [User])";
}
