...
@SuppressWarnings("all")public class RefArg_inputInt_1_EditSongModalSong_ModalType_ta1Song_ModalTypepc0 extends utils.RefArg{
public webdsl.generated.domain.Song song_;
public  RefArg_inputInt_1_EditSongModalSong_ModalType_ta1Song_ModalTypepc0(){}
public  RefArg_inputInt_1_EditSongModalSong_ModalType_ta1Song_ModalTypepc0(Object song_){
this.song_=(webdsl.generated.domain.Song)song_;
}
public webdsl.generated.domain.Song set(Object obj){
song_.setBpm((Integer)org.webdsl.tools.Utils.cast(obj,Integer.class));
return song_;
}
public Object get(){
return (Integer)song_.getBpm();
}
...
return song_.getId()+"!"+"RefArg_inputInt_1_EditSongModalSong_ModalType_ta1Song_ModalTypepc0";
}
...
song_.validateBpm_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Song").getPropertyByName("bpm");
}
