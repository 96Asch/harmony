...
@SuppressWarnings("all")public class songSearchInputSUserS_String_Placeholder_Bool_Bool_Template extends utils.TemplateServlet{
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.songSearchInputSUserS_String_Placeholder_Bool_Bool_ta0SUserS_String_Placeholder_Bool_Bool_String_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(songSearchInputSUserS_String_Placeholder_Bool_Bool_ta0SUserS_String_Placeholder_Bool_Bool_String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"songSearchInputSUserS_String_Placeholder_Bool_Bool":keyOverwrite,songSearchInputSUserS_String_Placeholder_Bool_Bool_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(songSearchInputSUserS_String_Placeholder_Bool_Bool_Template.class);
return staticEnv;
}
...
return "template songSearchInput(editors : {User}, query : String, ph : Placeholder, searchPublic : Bool, multipleAllowed : Bool)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if2542708580"+forelementid))==null){
...
getTemplatecalls().put("if2542708580"+forelementid,if0);
}
}
if(if0){
...
ident=(inForLoop?forelementid:"")+("form2542708580"+getUniqueId());
...
handleTemplateCall(phase,inForLoop,forelementid,"tcall2542708582","labelString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"Add a song:"},"labelString"),new org.webdsl.lang.Environment(env).putWithcall("elements#labelString",new utils.TemplateCall("songSearchInputSUserS_String_Placeholder_Bool_Bool_ta0SUserS_String_Placeholder_Bool_Bool_String",getElementsContext(),new Object[]{editors_,query_,ph_,searchPublic_,multipleAllowed_,new webdsl.generated.templates.RefArg_songSearchInputSUserS_String_Placeholder_Bool_Bool_Template0(songSearchInputSUserS_String_Placeholder_Bool_Bool_Template.this)},attrs)),"labelString",attrsmapout);
}
