...
@SuppressWarnings("all")public class EditSetListModalSetList_PlaceholderPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{setlist_,cPh_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new EditSetListModalSetList_Placeholder_Template();
}
...
combinedparams.append("{\"name\":\"").append("cPh").append("\", \"value\":\"").append(utils.HTMLFilter.filterEcmaWithinHTML(cPh_.toString())).append("\"},");
}
...
combinedparams.append("cPh").append("=").append(utils.HTMLFilter.filter(utils.URLFilter.filter(cPh_.toString()))).append("&");
}
...
combinedparams.append("<input type=\"hidden\" name=\"").append("cPh").append("\" value=\"").append(utils.HTMLFilter.filter(cPh_.toString())).append("\" />");
}
...
if(parammap.get("cPh")!=null){
cPh_=parammap.get("cPh");
}
}
