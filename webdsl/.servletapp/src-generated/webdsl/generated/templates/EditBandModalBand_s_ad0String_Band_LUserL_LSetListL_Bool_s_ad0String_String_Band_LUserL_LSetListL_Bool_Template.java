...
@SuppressWarnings("all")public class EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0String_String_Band_LUserL_LSetListL_Bool_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0String_String_Band_LUserL_LSetListL_Bool":keyOverwrite,EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0String_String_Band_LUserL_LSetListL_Bool_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0String_String_Band_LUserL_LSetListL_Bool_Template.class);
return staticEnv;
}
...
valid_=(utils.RefArg)args[5];
}
public String getUniqueName(){
return "EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0String_String_Band_LUserL_LSetListL_Bool";
}
public String getTemplateSignature(){
return "template EditBandModalBand_s_ad0String_Band_LUserL_LSetListL_Bool_s_ad0(EditBandModalBand_ia05 : String, EditBandModalBand_ia00 : String, band : Band, eligibleUsers : ref [User], eligibleSetlists : ref [SetList], valid : ref Bool)";
}
...
new webdsl.generated.actions.EditBandModalBand_ia0().run(threadLocalPageCached,getEnv(),getElementsContext(),(Boolean)valid_.get(),band_,band_,ident);
}
