...
@SuppressWarnings("all")public class RefArg_inputFile_1_AddSongModal_ta2Songpc0 extends utils.RefArg{
public webdsl.generated.domain.Song song_;
public  RefArg_inputFile_1_AddSongModal_ta2Songpc0(){}
public  RefArg_inputFile_1_AddSongModal_ta2Songpc0(Object song_){
this.song_=(webdsl.generated.domain.Song)song_;
}
public webdsl.generated.domain.Song set(Object obj){
song_.setChordFile((utils.File)org.webdsl.tools.Utils.cast(obj,utils.File.class));
return song_;
}
public Object get(){
return (utils.File)song_.getChordFile();
}
...
return song_.getId()+"!"+"RefArg_inputFile_1_AddSongModal_ta2Songpc0";
}
...
song_.validateChordFile_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Song").getPropertyByName("chordFile");
}
