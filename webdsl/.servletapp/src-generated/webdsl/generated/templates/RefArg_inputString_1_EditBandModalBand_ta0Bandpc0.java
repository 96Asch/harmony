...
@SuppressWarnings("all")public class RefArg_inputString_1_EditBandModalBand_ta0Bandpc0 extends utils.RefArg{
public webdsl.generated.domain.Band band_;
public  RefArg_inputString_1_EditBandModalBand_ta0Bandpc0(){}
public  RefArg_inputString_1_EditBandModalBand_ta0Bandpc0(Object band_){
this.band_=(webdsl.generated.domain.Band)band_;
}
public webdsl.generated.domain.Band set(Object obj){
band_.setName((String)org.webdsl.tools.Utils.cast(obj,String.class));
return band_;
}
public Object get(){
return (String)band_.getName();
}
...
return band_.getId()+"!"+"RefArg_inputString_1_EditBandModalBand_ta0Bandpc0";
}
...
band_.validateName_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Band").getPropertyByName("name");
}
