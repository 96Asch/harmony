...
@SuppressWarnings("all")public class ConfirmRemoveModalString_SetListPage extends utils.PageServlet{
public String getPageName(){
return "ConfirmRemoveModalString_SetList";
}
...
conversion();
loadArguments();
Object[] args=new Object[]{modalId_,setlist_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new ConfirmRemoveModalString_SetList_Template();
}
...
combinedparams.append("{\"name\":\"").append("modalId").append("\", \"value\":\"").append(utils.HTMLFilter.filterEcmaWithinHTML(modalId_.toString())).append("\"},");
...
combinedparams.append("modalId").append("=").append(utils.HTMLFilter.filter(utils.URLFilter.filter(modalId_.toString()))).append("&");
...
combinedparams.append("<input type=\"hidden\" name=\"").append("modalId").append("\" value=\"").append(utils.HTMLFilter.filter(modalId_.toString())).append("\" />");
...
if(parammap.get("modalId")!=null){
modalId_=parammap.get("modalId");
}
