...
@SuppressWarnings("all")public class RefArg_inputEmail_1_RegisterPlaceholder_ta1Placeholder_Userpc0 extends utils.RefArg{
public webdsl.generated.domain.User u_;
public  RefArg_inputEmail_1_RegisterPlaceholder_ta1Placeholder_Userpc0(){}
public  RefArg_inputEmail_1_RegisterPlaceholder_ta1Placeholder_Userpc0(Object u_){
this.u_=(webdsl.generated.domain.User)u_;
}
public webdsl.generated.domain.User set(Object obj){
u_.setEmail((String)org.webdsl.tools.Utils.cast(obj,String.class));
return u_;
}
public Object get(){
return (String)u_.getEmail();
}
...
return u_.getId()+"!"+"RefArg_inputEmail_1_RegisterPlaceholder_ta1Placeholder_Userpc0";
}
...
u_.validateEmail_internalValidationExceptionMultiple_(vem);
