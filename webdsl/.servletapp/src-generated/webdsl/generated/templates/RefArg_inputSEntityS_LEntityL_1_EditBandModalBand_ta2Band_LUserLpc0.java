...
@SuppressWarnings("all")public class RefArg_inputSEntityS_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0 extends utils.RefArg{
public webdsl.generated.domain.Band band_;
public  RefArg_inputSEntityS_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0(){}
public  RefArg_inputSEntityS_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0(Object band_){
this.band_=(webdsl.generated.domain.Band)band_;
}
public webdsl.generated.domain.Band set(Object obj){
band_.replaceAllInAdmins((java.util.Set<webdsl.generated.domain.User>)obj);
return band_;
}
public Object get(){
return (java.util.Set<webdsl.generated.domain.User>)band_.getAdmins();
}
...
return band_.getId()+"!"+"RefArg_inputSEntityS_LEntityL_1_EditBandModalBand_ta2Band_LUserLpc0";
}
