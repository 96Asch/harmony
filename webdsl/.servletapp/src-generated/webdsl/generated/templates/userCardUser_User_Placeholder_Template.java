...
@SuppressWarnings("all")public class userCardUser_User_Placeholder_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"userCardUser_User_Placeholder":keyOverwrite,userCardUser_User_Placeholder_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(userCardUser_User_Placeholder_Template.class);
return staticEnv;
}
...
return "userCardUser_User_Placeholder";
}
public String getTemplateSignature(){
return "template userCard(user : User, owner : User, ph : Placeholder)";
}
...
private static String c$79(webdsl.generated.domain.User user__){
try{
...
if(RENDER_PHASE==phase){
utils.RenderUtils.printPageString(""+"@"+c$79(user_),out,threadLocalPageCached.isRawoutput());
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall13980579340","memberButtonBarUser_User_Placeholder",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{owner_,user_,ph_},"memberButtonBarUser_User_Placeholder"),new org.webdsl.lang.Environment(env).putWithcall("elements#memberButtonBarUser_User_Placeholder",utils.TemplateCall.EmptyElementsCall),"memberButtonBarUser_User_Placeholder",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"memberButtonBarUser_User_Placeholder(owner, user, ph) at usersearch.app:91/10");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
