...
@SuppressWarnings("all")public class login_s_ad0String_String_Secret_Bool_Template extends utils.TemplateServlet{
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"login_s_ad0String_String_Secret_Bool":keyOverwrite,login_s_ad0String_String_Secret_Bool_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(login_s_ad0String_String_Secret_Bool_Template.class);
return staticEnv;
}
protected void storeArguments(Object[] args){
login_signinAction20_=(String)args[0];
credusername_=(utils.RefArg)args[1];
credpassword_=(utils.RefArg)args[2];
stayLoggedIn_=(utils.RefArg)args[3];
}
public String getUniqueName(){
return "login_s_ad0String_String_Secret_Bool";
}
public String getTemplateSignature(){
return "template login_s_ad0(login_signinAction20 : String, credusername : ref String, credpassword : ref Secret, stayLoggedIn : ref Bool)";
}
...
new webdsl.generated.actions.login_signinAction0().run(threadLocalPageCached,getEnv(),getElementsContext(),(Boolean)stayLoggedIn_.get(),(String)credpassword_.get(),(String)credusername_.get(),ident);
}
