...
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.login_s_ad0String_String_Secret_Bool_Template.class,null,utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.inputBool_Template.class,null,utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.inputSecret_Template.class,null,utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.inputString_Template.class,null,staticEnv))));
}
...
utils.AbstractPageServlet.loadRefArgClasses(login_s_ad0String_String_Secret_Bool_Template.class);
}
...
ident=(inForLoop?forelementid:"")+("form8287239690"+getUniqueId());
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall8287239692","labelcolumnsString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"Username: "},"labelcolumnsString"),new org.webdsl.lang.Environment(env).putWithcall("elements#labelcolumnsString",new utils.TemplateCall("inputString",utils.TemplateCall.SkipElementsMarker,new Object[]{new webdsl.generated.templates.RefArg_login_Template0(login_Template.this)},utils.TemplateCall.EmptyAttrs)),"labelcolumnsString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall82872396911","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"login_signinAction2"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("login_s_ad0String_String_Secret_Bool",getElementsContext(),new Object[]{new webdsl.generated.templates.RefArg_login_Template0(login_Template.this),new webdsl.generated.templates.RefArg_login_Template1(login_Template.this),new webdsl.generated.templates.RefArg_login_Template2(login_Template.this)},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
