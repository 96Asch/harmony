...
@SuppressWarnings("all")public class SongsLSongL_Template extends utils.TemplateServlet{
public void prefetchFor3673837410(java.util.List<webdsl.generated.domain.Song> list,boolean early){
if(early){}
else {}
}
public static void loadLiftedTemplateMap(org.webdsl.lang.Environment staticEnv){
utils.AbstractPageServlet.loadTemplateMap(webdsl.generated.templates.SongsLSongL_s_ad0String_LSongL_Song_Template.class,null,staticEnv);
}
public static void loadRefArgClasses(java.util.Map<String,Class<?>> refargclasses){
utils.AbstractPageServlet.loadRefArgClasses(SongsLSongL_s_ad0String_LSongL_Song_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"SongsLSongL":keyOverwrite,SongsLSongL_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(SongsLSongL_Template.class);
return staticEnv;
}
...
return "template Songs(songs : [Song])";
}
...
out.print(org.webdsl.tools.Utils.showAttributeEscapeHtml("data-bs-target","#addSong"));
utils.TemplateCall.printClassStyleAttributes(classattrs,styleattrs,out);
}
out.print(">");
}
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.Song>)getTemplatecalls().get("for20503058150"+forelementid))==null){
...
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for20503058150"+forelementid,forcol0);
}
}
int i0=-1;
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall20503058150","wrapsubmitString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"SongsLSongL_ia0_"+webdsl.generated.functions.getTemplate_.getTemplate_().getUniqueIdNoCache()},"wrapsubmitString"),new org.webdsl.lang.Environment(env).putWithcall("s",new utils.TemplateCall("SongsLSongL_s_ad0String_LSongL_Song",getElementsContext(),new Object[]{songs_,song_},attrs)),"wrapsubmitString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"wrapsubmitString(\"SongsLSongL_ia0\" + getTemplate().getUniqueIdNoCache()) at unknown context");
}
