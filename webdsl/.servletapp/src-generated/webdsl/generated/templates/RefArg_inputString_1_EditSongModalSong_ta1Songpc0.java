...
@SuppressWarnings("all")public class RefArg_inputString_1_EditSongModalSong_ta1Songpc0 extends utils.RefArg{
public webdsl.generated.domain.Song song_;
public  RefArg_inputString_1_EditSongModalSong_ta1Songpc0(){}
public  RefArg_inputString_1_EditSongModalSong_ta1Songpc0(Object song_){
this.song_=(webdsl.generated.domain.Song)song_;
}
public webdsl.generated.domain.Song set(Object obj){
song_.setSubtitle((String)org.webdsl.tools.Utils.cast(obj,String.class));
return song_;
}
public Object get(){
return (String)song_.getSubtitle();
}
...
return song_.getId()+"!"+"RefArg_inputString_1_EditSongModalSong_ta1Songpc0";
}
...
song_.validateSubtitle_internalValidationExceptionMultiple_(vem);
...
return utils.ThreadLocalServlet.get().getReflectionEntityByName("Song").getPropertyByName("subtitle");
}
