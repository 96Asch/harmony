...
@SuppressWarnings("all")public class UserSearchUser_String_PlaceholderPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{owner_,query_,ph_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new userSearchUser_String_Placeholder_Template();
}
