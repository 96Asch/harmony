...
@SuppressWarnings("all")public class RefArg_inputSecret_1_RegisterPlaceholder_ta2Placeholder_Userpc0 extends utils.RefArg{
public webdsl.generated.domain.User u_;
public  RefArg_inputSecret_1_RegisterPlaceholder_ta2Placeholder_Userpc0(){}
public  RefArg_inputSecret_1_RegisterPlaceholder_ta2Placeholder_Userpc0(Object u_){
this.u_=(webdsl.generated.domain.User)u_;
}
public webdsl.generated.domain.User set(Object obj){
u_.setPassword((String)org.webdsl.tools.Utils.cast(obj,String.class));
return u_;
}
public Object get(){
return (String)u_.getPassword();
}
...
return u_.getId()+"!"+"RefArg_inputSecret_1_RegisterPlaceholder_ta2Placeholder_Userpc0";
}
...
u_.validatePassword_internalValidationExceptionMultiple_(vem);
