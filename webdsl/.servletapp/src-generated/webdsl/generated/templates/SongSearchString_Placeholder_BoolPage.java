...
@SuppressWarnings("all")public class SongSearchString_Placeholder_BoolPage extends utils.PageServlet{
...
conversion();
loadArguments();
Object[] args=new Object[]{query_,ph_,searchPublic_};
this.args=args;
}
protected void initTemplateClass(){
templateservlet=new songSearchString_Placeholder_Bool_Template();
}
