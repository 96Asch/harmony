...
@SuppressWarnings("all")public class SetListsPlaceholder_s_ad2String_Placeholder_User_LSetListL_SetList_Template extends utils.TemplateServlet{
...
staticEnv.putTemplate(keyOverwrite==null?"SetListsPlaceholder_s_ad2String_Placeholder_User_LSetListL_SetList":keyOverwrite,SetListsPlaceholder_s_ad2String_Placeholder_User_LSetListL_SetList_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(SetListsPlaceholder_s_ad2String_Placeholder_User_LSetListL_SetList_Template.class);
return staticEnv;
}
...
return "SetListsPlaceholder_s_ad2String_Placeholder_User_LSetListL_SetList";
}
public String getTemplateSignature(){
return "template SetListsPlaceholder_s_ad2(SetListsPlaceholder_ShowSetListEdit10 : String, ph : Placeholder, u : ref User, setLists : ref [SetList], setlist : SetList)";
}
...
out.print(">");
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall18855988960","SetListCardSetList",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{setlist_},"SetListCardSetList"),new org.webdsl.lang.Environment(env).putWithcall("elements#SetListCardSetList",utils.TemplateCall.EmptyElementsCall),"SetListCardSetList",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"SetListCardSetList(setlist) at dashboard.app:279/14");
}
out.print("</a>");
}
else {
