...
@SuppressWarnings("all")public class search_Template extends utils.TemplateServlet{
public void prefetchFor_4372698100(java.util.List<webdsl.generated.domain.User> list,boolean early){
if(early){}
else {}
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"search":keyOverwrite,search_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(search_Template.class);
return staticEnv;
}
...
private static String c$14(String query__){
try{
Object v=query__;
if(v==null){
return "";
...
private static String c$15(webdsl.generated.domain.User u__){
try{
...
ident=(inForLoop?forelementid:"")+("form_13336955140"+getUniqueId());
...
String actionid0=(inForLoop?forelementid:"")+("action_13336955140"+getUniqueId());
if(threadLocalPageCached.getParammap().get(actionid0)!=null){
threadLocalPageCached.actionToBeExecutedHasDisabledValidation=webdsl.generated.actions.search_ia0.isValidationDisabled();
}
}
if(ACTION_PHASE==phase){
String actionid1=(inForLoop?forelementid:"")+("action_13336955140"+getUniqueId());
if(threadLocalPageCached.getParammap().get(actionid1)!=null){
threadLocalPageCached.enableAjaxActionExecuted();
new webdsl.generated.actions.search_ia0().run(threadLocalPageCached,getEnv(),getElementsContext(),new webdsl.generated.templates.RefArg_search_Template0(search_Template.this),results_,new webdsl.generated.templates.RefArg_search_Template0(search_Template.this),ident);
return;}
}
java.util.Map<String,String> attrsmapout=new java.util.HashMap<String,String>();
utils.TemplateCall.putAttributeMergeClassOrStyle(attrsmapout,"oninput","serverInvoke(\""+threadLocalPageCached.getAbsoluteLocation()+"/"+threadLocalPageCached.getActionTarget()+"\",\""+((inForLoop?forelementid:"")+("action_13336955140"+getUniqueId()))+"\", ["+threadLocalPageCached.getHiddenPostParamsJson()+"],\""+threadLocalPageCached.getFormIdent()+"\", this, "+"false"+",\""+threadLocalPageCached.placeholderId+"\");");
handleTemplateCall(phase,inForLoop,forelementid,"tcall_13336955140","inputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{new webdsl.generated.templates.RefArg_search_Template0(search_Template.this)},"inputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#inputString",utils.TemplateCall.EmptyElementsCall),"inputString",attrsmapout);
}
...
if(RENDER_PHASE==phase){
utils.RenderUtils.printPageString(""+"Results for: "+c$14(query_),out,threadLocalPageCached.isRawoutput());
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_13336955140"+forelementid))==null){
if0=!org.webdsl.tools.Utils.equal(query_,"");
if(RENDER_PHASE!=phase){
getTemplatecalls().put("if_13336955140"+forelementid,if0);
}
}
if(if0){
...
if(RENDER_PHASE==phase||(forcol0=(java.util.List<webdsl.generated.domain.User>)getTemplatecalls().get("for_13336955140"+forelementid))==null){
...
prefetchFor_4372698100(list1,true);
prefetchFor_4372698100(list1,false);
forcol0=list1;
if(RENDER_PHASE!=phase){
getTemplatecalls().put("for_13336955140"+forelementid,forcol0);
}
}
int i0=-1;
...
try{
handleTemplateCall(phase,inForLoop,forelementid,"tcall_13336955142","outputString",env.addExtraLocalTemplateArgumentsToArguments(new Object[]{""+c$15(u_)},"outputString"),new org.webdsl.lang.Environment(env).putWithcall("elements#outputString",utils.TemplateCall.EmptyElementsCall),"outputString",utils.TemplateCall.EmptyAttrs);
}
catch(RuntimeException ex){
printTemplateCallException(ex,"outputString(\"~u.username\") at dashmodal.app:165/23");
}
if(RENDER_PHASE==phase){
out.print("</"+"div"+">");
}
