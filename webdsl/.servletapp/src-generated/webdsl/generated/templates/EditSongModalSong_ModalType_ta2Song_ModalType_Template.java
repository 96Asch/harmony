...
@SuppressWarnings("all")public class EditSongModalSong_ModalType_ta2Song_ModalType_Template extends utils.TemplateServlet{
...
refargclasses.put("RefArg_inputEntity_1_EditSongModalSong_ModalType_ta2Song_ModalTypepc0",RefArg_inputEntity_1_EditSongModalSong_ModalType_ta2Song_ModalTypepc0.class);
utils.AbstractPageServlet.loadRefArgClasses(validateBool_String_Template.class);
}
public static org.webdsl.lang.Environment loadTemplateMap(String keyOverwrite,org.webdsl.lang.Environment staticEnv){
staticEnv.putTemplate(keyOverwrite==null?"EditSongModalSong_ModalType_ta2Song_ModalType":keyOverwrite,EditSongModalSong_ModalType_ta2Song_ModalType_Template.class);
utils.AbstractPageServlet.loadLiftedTemplateMap(EditSongModalSong_ModalType_ta2Song_ModalType_Template.class);
return staticEnv;
}
...
return "EditSongModalSong_ModalType_ta2Song_ModalType";
}
public String getTemplateSignature(){
return "template EditSongModalSong_ModalType_ta2(song : Song, type : ModalType)";
}
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if19665289980"+forelementid))==null){
...
getTemplatecalls().put("if19665289980"+forelementid,if0);
}
}
if(if0){
try{
