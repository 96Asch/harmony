...
@SuppressWarnings("all")public class logout_Template extends utils.TemplateServlet{
...
Boolean if0=null;
if(RENDER_PHASE==phase||(if0=(Boolean)getTemplatecalls().get("if_2434237820"+forelementid))==null){
...
getTemplatecalls().put("if_2434237820"+forelementid,if0);
}
}
if(if0){
if(RENDER_PHASE==phase){
...
ident=(inForLoop?forelementid:"")+("form_2434237820"+getUniqueId());
